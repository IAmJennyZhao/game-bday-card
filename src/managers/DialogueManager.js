...
export const dialogueData = {
    ...
    'Luo': {
        ...
        subtitles: [
            ...
            { time: 11, english: "But that's a good thing, that means you can do so many things", japanese: "でもそれはいいことだよ。できることがたくさん増えるからな。" },
            ...
            { time: 18, english: "Next time, we can keep playing games.", japanese: "今度またゲームしようぜ。" },
            { time: 24, english: "Next time is not only this year but next year I wish that we could just hangout for like forever", japanese: "今年だけじゃなく、来年も、その先もずっと一緒に遊べたらいいな。" },
            { time: 30.6, english: "That sounds cool though right. Let's keep it happy", japanese: "最高だろ？ 幸せでいようぜ。" },

            { time: 33, english: "If there's something that happened, just text me or tell me or tell Levenski or tell everybody", japanese: "何かあったら、俺にメッセージするか、Levenskiやみんなに話してくれ。" },
            { time: 40.7, english: "Everyone gonna help you and fix so many problems!", japanese: "みんなで助けて、きっと解決できるから！" },
            { time: 42.7, english: "Wish we can help you though", japanese: "本当はもっと助けてあげたいよ。" },

            { time: 45.8, english: "I just wanna say happy birthday yoooo", japanese: "とにかく、誕生日おめでとう！" },
            { time: 49.3, english: "Just be happy. Enjoy it", japanese: "笑って、楽しんでくれ。" },
            ...
            { time: 60.3, english: "and I wish one day we can meet each other in the real life then we can hang out", japanese: "いつか現実で会って、一緒に遊べたら最高だな！" },
    ...
    'Risu': {
        ...
        subtitles: [
            { time: 0, english: "hey void! i made this little site for your birthday and i hope you enjoy it!", japanese: "やあVoid！ 君の誕生日にちょっとしたサイトを作ってみたよ。気に入ってくれたら嬉しい！" },
            { time: 5, english: "I'm not one to speak sweet sentimental words so I asked some of your friends to give you messages instead! ", japanese: "甘い言葉を言うのは苦手だから、その代わりにみんなからのメッセージを集めたんだ！" },
            ...
            { time: 20, english: "I can't wait to play more games with ya!", japanese: "また一緒にゲームできるのを楽しみにしてる！" },
        ] 
    },
    ...
    'Howl': {
        ...
        subtitles: [
            ...
            { time: 20, english: "and since, you know we've been friends for a minute. I just gotta say something. ", japanese: "それと、もう友達になってけっこう経つし、 少し真面目なことも言わせて。" },
            ...
            { time: 32, english: "and shoot the shit in vc and it feels nice to just feel accepted in your server", japanese: "君のサーバーにいさせてもらえるのが。すごく楽しくてありがたい。" },
            { time: 43, english: "I don't know something sweet and embarrassing should be here. oh right um", japanese: "ここでなんか甘くて恥ずかしいことを言うべきなんだろうけど…あ、そうだな" },
            { time: 50, english: "you kind of are like a little brother to me, so I wanna like take care of you and like", japanese: "voidは俺にとって弟みたいな存在なんだ。だから、これからも支えていきたいし、" },
            { time: 54.5, english: "help you nurture and grow as a person, but I'm not gonna stop you from doing whatever you wanna do", japanese: "人としてもっと成長していくのを見守りたい。自分で選んで、失敗して、学んでいくのが人生だから。" },
            { time: 61.3, english: "and whatever choices you wanna make, you know you fuck around and find out, right?", japanese: "でも、やりたいことは自由にやっていいと思う。" },
            { time: 67.5, english: "that's how life is so, whatever you do, like, do it at 100% full force", japanese: "だから何をするにしても、全力でやって、" },
            { time: 74, english: "and keep that same energy until the next year, and then the next year", japanese: "その勢いのまま次の年も、その次の年も進んでいってくれ。" },
            { time: 80, english: "and just know that I'll be rooting for you. I'll be right behind you every step of the way", japanese: "俺はその背中をずっと応援してるよ。" },
            { time: 87.5, english: "that sounds creepy like I'm like stalking you it's not that, it's not weird I'm not trying to catch a case", japanese: "……って言うとちょっとストーカーっぽいなw。そんな意味じゃないから安心して！" },
    ...
    'Jorzi': {
        ...
        subtitles: [
            ...
            { time: 4.4, english: "I actually have no idea how old you are going to be this year but (old -risu)", japanese: "正直、お前が今年で何歳になるのか全然知らねえけどw（年寄りリズって感じだな）" },
    ...
    'Thighs': {
        ...
        subtitles: [
            ...
            { time: 11.5, english: "I know you've been through a lot in your life", japanese: "君はこれまで本当にいろんなことを経験してきたし、" },
            { time: 14, english: "and you're still struggle with a lot of things you know", japanese: "今でもいろんな悩みを抱えてると思う。" },
            ...
            { time: 33.2, english: "you've gotten through everything life's thrown at you", japanese: "人生でどんな困難があっても、全部乗り越えてきた。" },
            { time: 35.3, english: "and as gay as it sounds i'm you know really proud of you af", japanese: "ちょっとクサい言い方かもしれないけど、本気で誇りに思ってる。" },

            { time: 40, english: "and I've seen you grow in so many ways that you wouldn't realize yourself", japanese: "君自身は気づいてないかもしれないけど" },
            ...
            { time: 50.6, english: "I've seen you talk about working on a novel for years", japanese: "何年も前から小説の話してたけど、" },
            { time: 51.4, english: "and now you're actually working on it and it's fucking good", japanese: "今は実際に書いてて、それが本当にすごく良い" },
            { time: 55.8, english: "I've seen you improve a lot at singing and you know", japanese: "歌もめちゃくちゃ上手くなったよな。" },
            ...
            { time: 73, english: "and there are people who genuinely care about you ", japanese: "心から君を大切に思ってくれる人がたくさんいる。" },

            { time: 76, english: "and you know so so much more and I know it may not always be obvious to you ", japanese: "自分では分かりにくいかもしれないけど、" },
            { time: 81, english: "like I know I've seen it. I've seen your growth ", japanese: "君の成長を俺はちゃんと見てきた。" },
            { time: 85, english: "and no matter how hard you are on yourself, it's there", japanese: "どんなに自分を責めても、その成長は確かにそこにある。" },
            { time: 88, english: "and you know it's only going to be up from this point. ", japanese: "そして、ここからはもっと良くなっていくだけだ。" },

            { time: 90, english: "There will be bumps and dips along the way", japanese: "道の途中でつまづくこともあるだろうし、" },
            { time: 92, english: "you know you're still going to go through things", japanese: "これからも大変なことはあると思う。" },
            ...
            { time: 98.7, english: "It's only up from here.", japanese: "ここからは上がっていくだけだ。" },

            { time: 101, english: "You're genuinely like my best friend.", japanese: "君は本当に、俺にとって親友みたいな存在だ。" },
            ...
            { time: 116, english: "but we're also confiding in each other and pushing each other to get through so fucking much", japanese: "お互いに支え合って、いろんなことを乗り越えてきた。" },
            { time: 122, english: "you know we're always helping each other and", japanese: "助け合って、何でも話せる関係で、" },
            { time: 127, english: "you know we're so open in such a judgmental yet nonjudgmental way at the same time.", japanese: "遠慮なく笑い合えるのが本当にいい。" },
            ...
            { time: 141, english: "and you know we've seen so much of each other's lives and each other's growth", japanese: "お互いの人生も成長もずっと見てきた。" },
            ...
            { time: 155.8, english: "and it's the same with you.", japanese: "君も同じようにたくさんのことを乗り越えてきた。" },

            { time: 157, english: "I've seen you go through high school ", japanese: "君が高校を卒業するまでのことも、" },
            ...
            { time: 171.5, english: "We're both weird and gay as fuck.", japanese: "俺たち、二人とも変でちょっとゲイっぽいけどw" },
            { time: 173.5, english: "We've done so much together.", japanese: "たくさんのことを一緒に経験してきたよな。" },
            ...
            { time: 201, english: "and you know I just really like the unique friendship and dynamic we've had", japanese: "君との友情や関係性は本当に特別で" },
            { time: 205, english: "and it's different from any other friend I've had in a lot of ways.", japanese: "今までのどんな友達とも違う。" },
            ...
            { time: 214.5, english: "I know you feel lonely and empty often and all these sorts of things", japanese: "君が時々孤独や虚しさを感じるのは分かってる。" },
            { time: 218, english: "but as much as it helps, you have so many great friends ", japanese: "でも君には、本当に君を大事に思ってる" },
            { time: 223, english: "that really really care about you", japanese: "素晴らしい友達がたくさんいる。" },

            { time: 225, english: "I mean look at this huge setup", japanese: "見てみろよ、この誕生日のためのサプライズを。" },
            { time: 228, english: "that from Risu and all of your friends", japanese: "リスやみんなが君のために用意したんだ。" },
            { time: 230, english: "that we've done for your birthday.", japanese: "たとえ君が自分に厳しくしても、" },
            { time: 232, english: "People really do care about you even if you're sometimes hard on yourself.", japanese: "みんな本気で君を大切に思ってる。" },

            { time: 237, english: "Sometimes it feels like you're alone but you're not. ", japanese: "ひとりぼっちに感じる時もあるだろうけど、本当は全然ひとりじゃない。" },
            ...
            { time: 250.4, english: "and the next of your life really. ", japanese: "来年も、その先の人生も最高の年になりますように。" },
    ...
    'Scarfy': {
        ...
        subtitles: [
            ...
            { time: 4.8, english: "Just know that we all love you, and we wish you the best of luck moving to Oregon.", japanese: "みんな君のことを大好きだし、オレゴンでの新しい生活がうまくいくように祈ってるよ。" },
            { time: 8.5, english: "I hope you like it there, ", japanese: "あっちが気に入るといいな。" },
            { time: 9.5, english: "and know we'll always be here for you man.", japanese: "俺たちはいつでも君の味方だからな。" },
    ...
    'Mel': {
        ...
        subtitles: [
            { time: 0.0,  english: "Happy Birthday, Void! I hope you have a peaceful day today!", japanese: "誕生日おめでとう、Void！今日は穏やかでいい一日になりますように。" },
            { time: 7.0,  english: "Congratulations on the new age. Very proud of you.", japanese: "大人になったね。本当に誇らしいよ。" },
            { time: 11.0,  english: "Keep growing, you're still a little kid to me though. Happy Birthday!", japanese: "成長していってね。でも俺にとってはまだ子どもみたいなもんだけどな。誕生日おめでとう！" },
        ]
    },
